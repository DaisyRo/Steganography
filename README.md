...
| **Влияние типа контейнера** | • Естественные сцены (BOSS): $H \approx 1.00$ (макс. шумоподобность)<br>• Медицинские/научные: $H \approx 0.87–0.99$ (структурированы, выше уязвимость к χ²) |
